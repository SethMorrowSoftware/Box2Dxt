...
| Showcase polish | **BUILT — statically verified 2026-06-13** (pre-Wave-4: longer/re-spaced levels, the kit's first JOINT mechanics — wrecking ball / rope bridge / boulder / barrel — and four variety species; all example-side, zero Kit change, no harness bump) |
